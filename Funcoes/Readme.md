...
- Função que recebe dois números como parâmetros
- Checa se os números são iguais
- Checa se soma dos números é maior que 10 ou menor que 20
- Retorna <i>string</i> com os números inseridos e informando se são iguais ou não, e se é maior ou menor que 10 e 20
